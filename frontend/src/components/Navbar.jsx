  ...
  return (
    <div className='flex items-center justify-between text-sm pt-2 pb-0 border-b border-b-gray-400'>
      ...
      <div className='flex items-center gap-4'>
        ...
        {location.pathname === '/' && (
          <button
            onClick={() => window.open('https://DocAppointy-six.vercel.app', '_blank')}
          ...
          <div className='flex items-center gap-2 cursor-pointer group relative'>
            ...
            <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
              <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                ...
                <p onClick={() => navigate('my-DocAppointments')} className='hover:text-black cursor-pointer'>My DocAppointments</p>
