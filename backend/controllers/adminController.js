...
// API for DocAppointment cancellation
...
// API to get all DocAppointments list
const DocAppointmentsAdmin = async (req, res) => {
    try {

        const DocAppointments = await DocAppointmentModel.find({})
...
export {loginAdmin, addDoctor, allDoctors, DocAppointmentsAdmin, DocAppointmentCancel, adminDashboard}